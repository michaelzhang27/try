...
const stripe = Stripe(
  "sk_test_51PKqhjC2VK0rtw0WclYxNYB07hOuZOvO3rT1i380jgUaXZFPqf3x1PE8YQsaA0ob4vlcEaRez2Cqdue32xmoye0U00ddOS1bvb"
);
const app = express();
const PORT = 3000;
...
app.post("/nodemail", async (req, res) => {
  ...
  const transporter = NodeMailer.createTransport({
    service: "gmail",
    auth: {
      user: "doubletroubletrainingapp24@gmail.com",
      pass: "kijkezadjgvkhoof",
    },
  });
  let product_cards = ``;
